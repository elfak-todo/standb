export const timeSrp = (databaseDate: Date) => {
...
export const timeEng = (databaseDate: Date) => {
  const date = new Date(databaseDate);
...
export const justTime = (databaseDate: Date, lang: string) => {
  const date = new Date(databaseDate);
...
export const dateSrp = (databaseDate: Date) => {
  const date = new Date(databaseDate);
...
export const justDate = (databaseDate: Date, lang: string) => {
  const date = new Date(databaseDate);
...
export const dateEng = (databaseDate: Date) => {
  const date = new Date(databaseDate);
...
export const parseDate = (databaseDate: Date, language: string) => {
  const date = new Date(databaseDate);
